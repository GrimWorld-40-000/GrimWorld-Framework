...
namespace GW_Frame.Settings
{
    public class SettingsTabRecord_WeaponTags : SettingsTabRecord
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            Rect vertTabRect = new (0, 0, tabSection.width - 20, listHeight);
            ...
            {
                Rect tabRect = new (tabSection.x, tabListHeight, tabSection.width - 20, 80);
            ...
            Rect vertRect = new (settingsSection.x, 0, settingsSection.width - 20, settingsAreaListHeight);
            Widgets.BeginScrollView(settingsSection, ref scrollPositionList, vertRect);
            float settingsListHeight = 0;

            Rect generalRect = new (settingsSection.x + 10, settingsListHeight,
            ...
            {
                //Create rects
                Rect defRect = new (settingsSection.x, settingsListHeight, settingsSection.width - 20, 80);
        ...
        private IEnumerable<ListTabInfo> GenerateTabs()
        {
            ...
            foreach (ThingCategoryDef weaponsChildCategory in ThingCategoryDefOf.Weapons.childCategories
                         .Where(weaponsChildCategory => weaponsChildCategory != Grimworld_DefsOf.GW_TwoHanded && 
                                                        weaponsChildCategory != Grimworld_DefsOf.GW_Shield))
            {
            ...
            {
                return DefDatabase<ThingDef>.AllDefsListForReading
                    .Where(x => x.HasComp<Comp_ItemCraftingLimit>())
                    .OrderBy(x => x.label);
